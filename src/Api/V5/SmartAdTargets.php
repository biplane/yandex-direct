    ...
    public function __construct(EventDispatcherInterface $dispatcher, User $user)
    {
        parent::__construct($user->resolveWsdl(self::ENDPOINT), $dispatcher, $user, [
            'classmap' => [
                ...
                'SmartAdTargetStateSelectionEnum' => 'Biplane\YandexDirect\Api\V5\Contract\SmartAdTargetStateSelectionEnum',
                'StringConditionOperatorEnum' => 'Biplane\YandexDirect\Api\V5\Contract\SmartAdTargetStringConditionOperatorEnum',
                'SmartAdTargetsSelectionCriteria' => 'Biplane\YandexDirect\Api\V5\Contract\SmartAdTargetsSelectionCriteria',
