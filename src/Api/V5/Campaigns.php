...
class Campaigns extends ApiSoapClientV5
{
    ...
    public function __construct(Config $config, array $options)
    {
        $options['classmap'] = [
            ...
            'DynamicTextCampaignSearchStrategyPlacementTypesFieldEnum' => 'Biplane\YandexDirect\Api\V5\Contract\DynamicTextCampaignSearchStrategyPlacementTypesFieldEnum',
