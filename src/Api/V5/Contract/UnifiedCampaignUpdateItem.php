...
class UnifiedCampaignUpdateItem extends UnifiedCampaignBase
{
//    Can be omitted.
...
//    protected $PackageBiddingStrategy = null;
    ...
    public function getPackageBiddingStrategy(): ?UnifiedCampaignPackageBiddingStrategyUpdate
    {
     ...
     * @return $this
     */
    public function setPackageBiddingStrategy(?UnifiedCampaignPackageBiddingStrategyUpdate $value = null)
    {
