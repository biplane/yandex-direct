...
class TextCampaignSettingGet
{
     ...
     * Get Option
     *
     * @see \Biplane\YandexDirect\Api\V5\Contract\TextCampaignSettingsGetEnum
     *
     ...
     * @see \Biplane\YandexDirect\Api\V5\Contract\TextCampaignSettingsGetEnum
     *
     * @param 'EXCLUDE_PAUSED_COMPETING_ADS'|'ADD_OPENSTAT_TAG'|'ADD_METRICA_TAG'|'ADD_TO_FAVORITES'|'ENABLE_AREA_OF_INTEREST_TARGETING'|'ENABLE_CURRENT_AREA_TARGETING'|'ENABLE_REGULAR_AREA_TARGETING'|'ENABLE_SITE_MONITORING'|'ENABLE_BEHAVIORAL_TARGETING'|'ENABLE_AUTOFOCUS'|'REQUIRE_SERVICING'|'ENABLE_RELATED_KEYWORDS'|'ENABLE_EXTENDED_AD_TITLE'|'MAINTAIN_NETWORK_CPC'|'ENABLE_COMPANY_INFO'|'SHARED_ACCOUNT_ENABLED'|'DAILY_BUDGET_ALLOWED'|'CAMPAIGN_EXACT_PHRASE_MATCHING_ENABLED'|'ALTERNATIVE_TEXTS_ENABLED' $value
     *
     * @return $this
     */
