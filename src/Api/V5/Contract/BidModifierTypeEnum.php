...
class BidModifierTypeEnum
{
    ...
    const TABLET_ADJUSTMENT = 'TABLET_ADJUSTMENT';

    const DESKTOP_ONLY_ADJUSTMENT = 'DESKTOP_ONLY_ADJUSTMENT';
    ...
    const SERP_LAYOUT_ADJUSTMENT = 'SERP_LAYOUT_ADJUSTMENT';

    const INCOME_GRADE_ADJUSTMENT = 'INCOME_GRADE_ADJUSTMENT';
