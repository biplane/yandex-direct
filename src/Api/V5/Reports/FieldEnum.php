...
final class FieldEnum
{
    ...
    public const AUDIENCE_TARGET_ID = 'AudienceTargetId';
    public const AVG_CLICK_POSITION = 'AvgClickPosition';
    public const AVG_CPC = 'AvgCpc';
    public const AVG_CPM = 'AvgCpm';
    public const AVG_EFFECTIVE_BID = 'AvgEffectiveBid';
    public const AVG_IMPRESSION_FREQUENCY = 'AvgImpressionFrequency';
    public const AVG_IMPRESSION_POSITION = 'AvgImpressionPosition';
    public const AVG_PAGEVIEWS = 'AvgPageviews';
    ...
    public const MATCHED_KEYWORD = 'MatchedKeyword';
    ...
    public const WEIGHTED_CTR = 'WeightedCtr';
    public const WEIGHTED_IMPRESSIONS = 'WeightedImpressions';
